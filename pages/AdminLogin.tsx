  ...
  return (
    <div className="min-h-screen bg-[#064e3b] flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-lg bg-white p-16 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] relative">
        ...
        {error && (
          <div className="bg-red-50 text-red-700 p-5 text-[10px] font-black mb-10 border-l-4 border-red-500 uppercase tracking-widest text-center">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          <div>
            ...
            <input 
              ...
              className="w-full border-b-2 border-gray-100 px-0 py-4 focus:border-[#064e3b] outline-none transition-all font-bold text-gray-800"
              placeholder="admin@amofarma.ao"
            />
          </div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#064e3b] hover:bg-black text-white py-6 font-black text-[10px] uppercase tracking-[0.3em] transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-16 pt-10 border-t border-gray-50 text-center">
          <Link to="/" className="text-[10px] font-black text-gray-400 hover:text-emerald-600 transition uppercase tracking-widest">
